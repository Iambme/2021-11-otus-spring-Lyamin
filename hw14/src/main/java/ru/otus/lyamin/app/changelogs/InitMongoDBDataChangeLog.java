package ru.otus.lyamin.app.changelogs;
...
import java.util.List;
    ...
    public class InitMongoDBDataChangeLog {
        ...
        public void init(MongockTemplate template) {
            MongoAuthor author1 = new MongoAuthor(ObjectId.get().toString(), "AuthorF1");
            MongoAuthor author2 = new MongoAuthor(ObjectId.get().toString(), "AuthorF2");
            MongoAuthor author3 = new MongoAuthor(ObjectId.get().toString(), "AuthorF3");
