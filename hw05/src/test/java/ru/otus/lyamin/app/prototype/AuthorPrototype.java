...
public class AuthorPrototype {
    public static Author getAuthor() {
        return new Author(1L, "testAuthorFirstname1", "TestAuthorLastname1");
    }

    public static Author getAnotherAuthor() {
        return new Author(2L, "testAuthorFirstname2", "TestAuthorLastname2");
    }
    public static Author getDeletableAuthor() {
        return new Author(3L, "testAuthorForDelete", "testAuthorForDelete");
    }
